/*
  # Audit Table - Complete Combined Script
  
  This script creates the complete audit table setup for tracking
  distribution and transfer operations. Run this as a single script.
  ...
  - Composite unique constraint on (building_number, created_at, action_type)
*/

-- ============================================================================
-- STEP 1: CREATE ENUM FOR ACTION TYPE
-- ============================================================================
...
-- ============================================================================
-- STEP 7: CREATE LOG_AUDIT FUNCTION
-- ============================================================================
