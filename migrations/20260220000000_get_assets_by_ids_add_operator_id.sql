/*
  # Add operator_id to get_assets_by_ids return

  Export flow uses operator_id to group assets by operator and send per-operator
  emails. Without it, byOperator is always empty and "לא נשלח אימייל" is shown.
*/
