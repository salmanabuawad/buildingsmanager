-- Add back building shared_parking_area and number_of_parking_units (parking_area stays removed).
...
COMMENT ON COLUMN buildings.shared_parking_area IS 'שטח חניה משותף - Shared parking area for building';
...
VALUES
  ('buildings-list', 'shared_parking_area', 10, 2, 'שטח חניה משותף', false, null, true, NULL),
  ('buildings-list', 'number_of_parking_units', 10, 2, 'מספר יחידות חניה', false, null, true, NULL)
...
-- Update update_buildings_bulk_with_distribution_flags to SET shared_parking_area and number_of_parking_units
...
COMMENT ON FUNCTION update_buildings_bulk_with_distribution_flags IS 'Bulk update buildings with distribution flags. Includes shared_parking_area and number_of_parking_units.';
