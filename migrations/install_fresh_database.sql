/*
  ...
  Usage (from repo root):
    psql -U postgres -d your_database -f migrations/install_fresh_database.sql

  Or run from psql with \i after cd to repo root.
...
-- ============================================================================
\i migrations/20251227000000_add_use_shared_area_to_asset_types.sql

-- ============================================================================
-- STEP 7: Ensure get_or_create_user_from_auth function exists
-- ============================================================================
\i migrations/20251226000000_ensure_get_or_create_user_from_auth_function.sql
