-- Quick script to populate asset_type_fields from existing asset types
-- Run this after creating the asset_type_fields table
-- This will scan all existing asset types and add their fields to the asset_type_fields table
