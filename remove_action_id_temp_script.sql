/*
  =============================================================================
  TEMPORARY SCRIPT: Remove all action_id references from the system
  =============================================================================
  This script contains all changes to remove action_id from:
  - log_audit_for_asset function
  - log_audit_for_building function
  - copy_asset_to_history_before_update function
  - get_asset_audit_data function
  - get_building_audit_data function
  - save_assets_bulk_transactional function (in save_assets_bulk_transactional)
  =============================================================================
*/
...
/*
  =============================================================================
  NOTE: The save_assets_bulk_transactional function changes are in the
  migration file 20251218000000_remove_backend_validation_checks.sql
  
  The key changes there are:
  1. Removed action_id from INSERT INTO assets_history
  2. Removed action_id from UPDATE assets SET
  3. Added removal of action_id from JSONB when collecting before/after data:
     - v_asset_jsonb := v_asset_jsonb - 'action_id';
  =============================================================================
*/
