    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8 bg-gradient-to-r from-blue-600 to-teal-600 rounded-xl shadow-lg p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">ייבוא בניינים מקובץ CSV</h1>
            <p className="text-blue-50 mt-1">העלה קובץ CSV כדי לייבא בניינים במרוכז</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-blue-100 p-8">
        <div className="mb-8">
          ...
          <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
            <p className="text-slate-700 mb-4 font-medium">כל שורה בקובץ CSV צריכה להכיל:</p>
