      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <Building className="h-5 w-5 text-theme-tab-active" />
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-theme-tab-active rounded-lg hover:bg-theme-tab-active-hover disabled:opacity-50  transition-colors"
          >
            {isValidating ? (
