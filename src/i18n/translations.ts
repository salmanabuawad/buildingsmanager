export const translations = {
  en: {
    translation: {
      ...
      viewerDescription: 'Can view all buildings and assets but cannot edit anything',
      editorDescription: 'Can view and edit assets, add/edit/delete measurements, and upload files',
  ...
  he: {
    translation: {
      ...
      search: 'חיפוש',
      searchByBuildingNumber: 'חיפוש לפי מזהה מבנה',
      reset: 'איפוס',
      subAssetType1: 'סוג 1',
