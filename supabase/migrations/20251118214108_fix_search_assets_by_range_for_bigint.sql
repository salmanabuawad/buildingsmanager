/*
  # Fix search_assets_by_range function for bigint asset_id

  1. Changes
    - Remove regex check since asset_id is now bigint (not text)
    - Simplify function to directly compare bigint values
...
-- Create updated function for bigint asset_id
