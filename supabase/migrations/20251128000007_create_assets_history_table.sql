/*
  # Create Assets History Table
  
  This migration creates the assets_history table:
  - Create assets_history table with all columns matching assets table
  - Set up RLS policies
  - Create helper functions and views
  
  Note: The copy_asset_to_history trigger function is defined in the assets migration
  (20251126000006_create_assets_table.sql).
*/
