/*
  # Rename shared area columns, add business shared area column, and ensure overload_ratio exists
  ...
  2. Column Details
    ...
    - overload_ratio: numeric(5,2) - Overload ratio percentage (אחוז העמסה)
*/
