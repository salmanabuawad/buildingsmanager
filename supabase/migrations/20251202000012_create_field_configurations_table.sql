...
CREATE TABLE IF NOT EXISTS field_configurations (
  ...
  hebrew_name text,
  pinned text, -- 'left', 'right', or 'false' for no pinning
...
COMMENT ON COLUMN field_configurations.pinned IS 'Pin position: left, right, or false for no pinning';
...
INSERT INTO field_configurations (field_name, width_chars, padding, hebrew_name, pinned) VALUES
  ('building_number', 12, 8, 'מספר מבנה', 'false'),
  ('asset_id', 12, 8, 'זיהוי נכס', 'false'),
  ('payer_id', 12, 8, 'זיהוי משלם', 'false'),
  ('tax_region', 10, 8, 'אזור מס', 'false'),
  ('main_asset_type', 10, 8, 'סוג נכס', 'false'),
  ('asset_size', 12, 8, 'גודל נכס', 'false'),
  ('measurement_date', 12, 8, 'תאריך מדידה', 'false'),
  ('sub_asset_type_1', 10, 8, 'סוג 1', 'false'),
  ('sub_asset_size_1', 12, 8, 'גודל 1', 'false'),
  ('sub_asset_type_2', 10, 8, 'סוג 2', 'false'),
  ('sub_asset_size_2', 12, 8, 'גודל 2', 'false'),
  ('sub_asset_type_3', 10, 8, 'סוג 3', 'false'),
  ('sub_asset_size_3', 12, 8, 'גודל 3', 'false'),
  ('sub_asset_type_4', 10, 8, 'סוג 4', 'false'),
  ('sub_asset_size_4', 12, 8, 'גודל 4', 'false'),
  ('sub_asset_type_5', 10, 8, 'סוג 5', 'false'),
  ('sub_asset_size_5', 12, 8, 'גודל 5', 'false'),
  ('sub_asset_type_6', 10, 8, 'סוג 6', 'false'),
  ('sub_asset_size_6', 12, 8, 'גודל 6', 'false'),
  ('private_shared_area', 15, 8, 'שטח משותף מגורים', 'false'),
  ('business_shared_area', 15, 8, 'שטח משותף עסקים', 'false'),
  ('total_building_area', 15, 8, 'ס"כ גודל', 'false'),
  ('area_for_control', 15, 8, 'שטח לבקרה', 'false'),
  ('overload_ratio', 12, 8, 'אחוז העמסה', 'false'),
  ('elevator', 10, 8, 'מעלית', 'false'),
  ('penthouse', 8, 8, 'דירת גג', 'false'),
  ('floor', 8, 8, 'קומה', 'false'),
  ('discount_type', 10, 8, 'סוג הנחה', 'false'),
  ('discount_date_from', 12, 8, 'תאריך הנחה מ', 'false'),
  ('discount_date_to', 12, 8, 'תאריך הנחה עד', 'false'),
  ('structure_drawing_url', 15, 8, 'שרטוט מבנה', 'false'),
  ('name', 15, 8, 'שם', 'false'),
  ('description', 20, 8, 'תיאור', 'false'),
  ('street_code', 10, 8, 'קוד רחוב', 'false'),
  ('street_description', 25, 8, 'כתובת', 'false'),
  ('single_double_family', 20, 8, 'בית פרטי חד משפחתי דו משפחתי', 'false'),
  ('condo', 10, 8, 'בית משותף', 'false'),
  ('townhouses', 20, 8, 'מבנים צמודי קרקע טוריים מעל 2 יחידות', 'false'),
  ('gosh', 8, 8, 'גוש', 'false'),
  ('helka', 8, 8, 'חלקה', 'false'),
  ('building_number_in_street', 12, 8, 'מספר בניין', 'false'),
  ('building_address', 10, 8, 'כתובת', 'false'),
