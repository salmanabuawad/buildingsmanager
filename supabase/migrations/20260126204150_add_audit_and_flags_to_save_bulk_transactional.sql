/*
  # Add audit logging and flag clearing to save_assets_bulk_transactional
  
  1. Overview
    - Add audit logging via log_audit_entry when saving assets
    - Clear distribution flags when action_type is business_distribution or residence_distribution
    
  2. Changes
    - Call log_audit_entry to create audit record
    - Clear need_business_distribution or need_residence_distribution flags
    - Collect after_data if not provided
*/
...
'bulk_asset',
array_to_string(v_affected_asset_ids, ','),
p_user_id,
