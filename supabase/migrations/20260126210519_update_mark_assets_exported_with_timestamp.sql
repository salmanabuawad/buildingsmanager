/*
  # Update mark_assets_as_exported_to_automation function

  1. Overview
    - Updates the function to set both flag and timestamp
    
  2. Changes
    - Add export_to_automation_at = NOW() to UPDATE statement
*/
...
BEGIN
  ...
  -- Update the assets (set flag and timestamp)
  UPDATE assets
