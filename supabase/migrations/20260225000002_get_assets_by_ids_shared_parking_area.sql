-- Add shared_parking_area to get_assets_by_ids return (run after 20260225000000 adds column to assets)
...
BEGIN
  ...
  SELECT
    ...
    a.operator_id, a.shared_parking_area
  FROM assets a
...
COMMENT ON FUNCTION get_assets_by_ids(bigint[]) IS 'Returns assets by IDs. Includes business_total_area, operator_id, shared_parking_area.';
