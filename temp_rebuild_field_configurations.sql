/*
  # Temporary Script: Rebuild All Field Configurations
  
  This script combines all field configuration updates into a single script.
  Use this for testing or applying all changes at once.
  
  Configuration Rules:
  - padding = 2 for all fields
  - default width_chars = 6 for all fields
  - asset_id, building_number, payer_id, actions: width 10
  - checkboxes: width 4
  - asset types/subtypes: width 4
  - asset sizes/subsizes: width 6
  - dates: width 10
  - tax_region: width 5
  - All pinned fields: pin_side = 'right'
*/

-- ============================================================================
-- STEP 1: Update table defaults
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Insert all field configurations for all grids
-- ============================================================================
...
-- ============================================================================
-- STEP 4: Apply safeguard UPDATE statements to ensure consistency
-- ============================================================================
...
-- Set default width_chars = 6 and padding = 2 for any remaining fields
UPDATE field_configurations
...
-- ============================================================================
-- COMPLETE: All field configurations have been rebuilt
-- ============================================================================
